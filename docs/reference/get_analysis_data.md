...
A [`tibble::tibble()`](https://rdrr.io/pkg/tibble/man/tibble.html) for
tabular modules (deg, go, kegg, gsea, immune, tf), or a named list for
structured modules (meta, expression, ppi, pca, qc).
